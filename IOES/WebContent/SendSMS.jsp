	...
	<table width="50%" border="0" cellpadding="0" cellspacing="0" class="border" align="center">
		<tr valign="middle">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td><img src="Images/tabLeft.gif"></td>
					<td background="Images/tabbg.gif" class="tabHeading" width="30%">Send SMS</td>
					<td><img src="Images/tabRight.gif"></td>
					<td width="70%"><img src="Images/zero.gif" width="15" height="1"></td>
				</tr>
			</table>
			</td>
		</tr>
	...
	<table width="50%" border="0" cellpadding="0" cellspacing="0" class="border" align="center">
		<tr valign="middle">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td><img src="Images/tabLeft.gif"></td>
					<td background="Images/tabbg.gif" class="tabHeading" width="30%">Send Email</td>
					<td><img src="Images/tabRight.gif"></td>
					<td width="70%"><img src="Images/zero.gif" width="15" height="1"></td>
				</tr>
			</table>
