...
<link type="text/css" rel="stylesheet" href="gifs/style.css">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<tr valign="middle" id="projectPlan">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td background="gifs/tabbg.gif" class="tabHeading" width="30%">An
	...
	<%
			if (exception != null) {
			//AppConstants.IOES_LOGGER.error(Utility.getStackTrace(exception));
		}
