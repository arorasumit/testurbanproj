...
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="com.ibm.ioes.forms.CurrencyChangeDto"%>
<%@page import="java.util.Date"%>
...
<title>View Currency Change</title>
<style type="text/css">
/* CSS for the demo */
img{
	border:0px;
...
function fnViewCurrencyChangePage(BatchId)

{
      ...
      document.forms[0].action="./currencyChange.do?method=ViewCurrencyChangePage&BatchId="+BatchId;
      showLayer();
...
function searchSubmit()
{
	...
	if(searchFlag==1)
	{
		...
		{
		myForm.action="<%=request.getContextPath()%>/currencyChange.do?method=ViewCurrencyChangeList";
		showLayer();
		myForm.submit(); 
		}
	}	
...
<div class="Head"><span>View Currency Change</span></div>
<table width="100%" border="0" cellpadding="0" cellspacing="0"
	...
	<html:form action="/currencyChange" method="post" styleId="searchForm">
	...
	<fieldset width="100%" border="1" align="center" class="border3">
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<table width="100%">
				<tr>
					<td>
						<%	String currPageNumber =String.valueOf(((CurrencyChangeBean)formBean).getPagingSorting().getPageNumber());
							String 	maxPageNumber =String.valueOf(((CurrencyChangeBean)formBean).getPagingSorting().getMaxPageNumber());
						%>
			...
			<table class="tab2" style="overflow:auto;" width="99%" border="1" align="center" id='tblCurrencyChangeDetails'>
				<tr>
				...
				<logic:present name="CurrencyChangeList" scope="request">
					<logic:notEmpty  name="CurrencyChangeList" scope="request"> 					
						<logic:iterate id="row" name="CurrencyChangeList" indexId="recordId">
							<%
							...
							<tr class="<%=classType%>">
								<td align="left" style="font-size:9px">
									<a href="javascript:fnViewCurrencyChangePage('<bean:write name="row" property="searchBatchId" />');">
									<font color="Brown">   
					...
					<logic:empty  name="CurrencyChangeList">
					   <tr align="center" >
