...
<!--[001]	 MANISHA GARG	21-feb-12	00-05422		Check Mandatory nonmandatory field -->
...
tblRow.onclick = function(){changeUpperBackground();};//Added by Ashutosh for highlighting row		
		...
		str ="<input type='text' onmouseover='getTip(value)' onmouseout='UnTip()' style='width:100px' class='inputDisabled' name='components' isRequired='0' id='components"+counter+"'  value = ' " + components[i] + " ' readonly='true'>";
		CellContents = str;
		tblcol.innerHTML = CellContents;
		...
		str ="<input type='text' onmouseover='getTip(value)' onmouseout='UnTip()' class='inputDisabled' name='componentsName' isRequired='0' style='width:250px' id='componentsName"+counter+"'  value = ' " + componentsName[i] + " ' readonly='true'>";
		CellContents = str;
		tblcol.innerHTML = CellContents;
		...
		tblcol.vAlign="top";
		tblcol.className="innerdata secondColumn";
		str ="<input type='text' onmouseover='getTip(value)' onmouseout='UnTip()' style='width:100px' class='inputDisabled' name='packageID' isRequired='0'  id='packageID"+counter+"'  value = ' " + packageID[i] + " ' readonly='true'>";
		CellContents = str;
		tblcol.innerHTML = CellContents;
		...
		tblcol.vAlign="top";
		tblcol.className="innerdata secondColumn";
		str ="<input type='text' onmouseover='getTip(value)' onmouseout='UnTip()' style='width:100px' class='inputDisabled' name='status' isRequired='0' readonly='readonly'  id='status"+counter+"'  value = 'NEW' >";
		CellContents = str;
		tblcol.innerHTML = CellContents;
