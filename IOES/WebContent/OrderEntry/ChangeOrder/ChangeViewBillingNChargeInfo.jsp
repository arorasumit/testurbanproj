...
<body>
		...
		<input name="btn1" id="btnBillingAndChargesInformation"
			onClick="if(this.value == '+')getBillingInfo();show('tblBillingAndChargesInformation',this)" type="button" value="+"
		...
		<div class="scroll" style="height:100%">
			...
			<tr align="center" id="BillingInfo" style="display:none">
						<td colspan="2" width="50%">
							<jsp:include flush="true" page="ChangeviewBillingInfo.jsp"></jsp:include>
						</td>
					</tr>
					<tr align="center" id="ChargeDetails" style="display:none">
						<td colspan="2" width="50%">
							<jsp:include flush="true" page="ChangeviewChargeDetails.jsp"></jsp:include>
						</td>
					</tr>
			</table>
		</div>
