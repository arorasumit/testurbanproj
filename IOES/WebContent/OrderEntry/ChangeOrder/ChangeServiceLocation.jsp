				...
				<fieldset class="border1" id="PriBCPLocation" style="display: none">
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
						<tr>
							...
							<td width="80%">
							<!--     Select Customer Location  commented lawkush [003] Start
								...
								<!--   Auto suggest Customer location  lawkush [003]  end -->
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">
					...
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="50%">
								...
								<!-- Start[008] -->
								<input onmouseover="getTip(value)" onmouseout="UnTip()" type="hidden" name="ddSNLocation" id="ddSNLocation"  value="0"  readonly="true" isRequired="1" styleClass="inputBorder1" style="width:110px;float:right;">
								<!-- End[008] -->
							</td>
						</tr>
					</table>
			...
			<td width="100%" colspan="2">	
				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td width="31%">
							<input onmouseover="getTip(value)" onmouseout="UnTip()" type="text" class="inputBorder" style="width:80%;float:right" name="txtFAddress" value="" isRequired="0" maxlength="25" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'From Address')};">
						</td>
						<td width="21%">
							To Address
						</td>
						<td width="80%">
							<input onmouseover="getTip(value)" onmouseout="UnTip()" type="text" class="inputBorder" style="width:80%;float:right" name="txtToAddress" value="" isRequired="0" maxlength="25" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'To Address')};">
						</td>
					</tr>
				</table>
				</fieldset>
