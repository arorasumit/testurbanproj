						...
						<table border="1" cellspacing="0" cellpadding="0"  width="100%">
							...
							<!-- Start[004] -->																
								...
								<td width="32%" align="left" nowrap>
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtPODetailNo" style="width:150px"
								...
								<!-- End[004] -->
									...
									<td width="16%" align="left" nowrap class="columnFontSmall">
										<input onmouseover='getTip(value)' onmouseout='UnTip()' type="text"  class="inputBorder1" style="width:90px" name="txtBillingPODate" id="txtBillingPODate" isRequired="0" readonly="true" value="<%=request.getParameter("orderDate")%>">
									</td>
								<td width="40%" nowrap class="columnFontSmall">
									Contract Period 
								</td>
								<td width="17%" align="left" nowrap class="columnFontSmall">
									<input onmouseover='getTip(value)' onmouseout='UnTip()' type="text"  class="inputBorder1" name="txtCntrtMonths" style="width:50px" id="txtCntrtMonths"  isRequired="0" readonly="true">
									(Months)
								</td>
							</tr>
							...
							<tr>																								
								...
								<td width="32%" align="left" nowrap>									
									...
									id="txtEntity" class="dropdownMargin"
									onchange='fnFetchLicCompany(path);'  isRequired="0">
								...
								<td width="17%" align="left" nowrap class="columnFontSmall">
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtBillingCP" id="txtBillingCP" class="inputBorder1" style="width:150px "  isRequired="0">
							...
							<tr>																																
								...
								<td width="32%" align="left" nowrap>
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' onfocus='getPrevBillFormat(this.selectedIndex);' name="txtBillingformat" id="txtBillingformat" style="width:150px" class="dropdownMargin" isRequired="0"  onchange="setTypeofSale()">
								...
								<td width="16%" align="left" nowrap class="columnFontSmall">
									...
									<input type="hidden" name="hdnTaxation">						
								</td>
							...
							<tr>
								...
								<td width="17%" align="left" nowrap class="columnFontSmall">
									<input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" class="inputBorder1" style="width:50px" name="txtNoticePeriod" value="0" id="txtNoticePeriod" maxlength="5" isRequired="0" onblur="if( trim(this.value).length>0){ return checkdigits(this)};" /> 
							...
							<tr>																							
								...
								<td width="32%" align="left" nowrap>
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtBillingLvl"  id="txtBillingLvl"class="dropdownMargin"  onchange=setBillingLevelNo(this.value); style="width:150px" isRequired="0">
								...
								<td width="16%" align="left" nowrap class="columnFontSmall">
									<input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" class="inputBorder1" maxlength="5" 
									style="width:90px;float:left;" value="0" name="txtBillingLevelNo" id="txtBillingLevelNo"
									readonly="readonly"  onblur="if( trim(this.value).length>0){return checkdigits(this)};">
								</td>
								...
								<td width="17%" align="left" nowrap class="columnFontSmall">
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtBillingType" class="dropdownMargin" id="txtBillingType" style="width:150px">
							...
							<tr>																
								...
								<td width="32%" align="left" nowrap>
									<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtBillingMode" id="txtBillingMode" style="width:150px" class="dropdownMargin" isRequired="0">
								...
								<td width="16%" align="left" nowrap class="columnFontSmall">
									<input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" name="txtCur" class="inputBorder1" style="width:90px" value="<bean:write name="newOrderBean" property="curShortCode"/>" readonly="true">
								</td>
								<!--Start[003]  -->
								<td width="40%" nowrap class="columnFontSmall">
									Commitment Period
							...
							<tr>																
								...
								<td colspan="3" align="left">
									<textarea onmouseover='getTip(value)' onmouseout='UnTip()' class="inputBorder1" rows="5" id="txtPenaltyClause" name="txtPenaltyClause" maxlength="999" style="width:100%; " isRequired="0"></textarea> 
								</td>	
