	...
	<div class="scroll" style="height:100%">
		<fieldset class="border1">
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" id="tblHwDetails" style="display: none;">
				...
				<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)'
					name="txtHtype" id="txtHtype" class="dropdownMargin" onchange='refreshTaxRate(path);' isRequired="0" style="width:150px";
					isRequired="0" style="width:150px";>
				...
				<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtNSale"
					id="txtNSale" class="dropdownMargin" onchange='refreshTaxRate(path);' isRequired="0" style="width:150px"; style="width:150px"">
				...
				<td></td>
							...
							<tr>
								...
								<td> <select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtTSale" id="txtTSale" class="dropdownMargin" isRequired="0" style="width:150px"; style="width:150px"  onchange="setPAandIR();refreshTaxRate(path);">
					...
					<td width="100%" valign="top" align="left">
						<table width="100%" border="0" cellpadding="1" cellspacing="0" style="margin-top:7px ">
							<tr>
								...
								<td width="25%">
									<!--<select onmouseover='getTip_DD(this,this.selectedIndex,this.name)' name="txtdispatchAddress" class="dropdownMargin" onchange="getDispatchAddress()"  isRequired="0" style="width:150px"; style="width:150px">
