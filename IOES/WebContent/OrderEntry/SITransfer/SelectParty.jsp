...
[001]                     22-Jan, 2014       Santosh Srivastava              Added conditions for fetch source and destination party on babes of responsibility
...
function getInfoAndUpdate(partyNo,partyName) 
{
	...
	if(callerWindowObj.document.getElementById('source').value == 'SOURCE' ) 
	{
	...
	{
		callerWindowObj.document.searchForm.targetPartyNo.value = partyNo;
		callerWindowObj.document.searchForm.targetPartyName.value = unescape(partyName);
		window.close();
	}
...
//[001]
var respIdValue = '<%=objUserDto.getRespId()%>';
//[001]
...
{
		var callerWindowObj = dialogArguments;
		var selectedSourcePartyNo=0;
		if(callerWindowObj.document.getElementById('source').value=='TARGET')
		{
		 selectedSourcePartyNo=callerWindowObj.document.getElementById('sourcePartyNo').value;
		}
	   	  ...
	   	  var jsData =
				{
					...
					sourcePartyID:selectedSourcePartyNo,
...
<body>
<html:form action="/siTransfer" styleId="parties" method="post">
