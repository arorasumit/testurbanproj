				...
				<b>Service Summary</b> </legend>
					...
					<table width="100%"  border="1" cellspacing="0" cellpadding="0"> 
						<tr>
							...
							{
							%>
								<td width="59%" align="center">Value</td>							
							<%} %>
							<!-- [001]	End -->
						</tr>
				  	</table>
					  		...
					  		<table width="100%"  border="1" cellspacing="1" cellpadding="2"  >
					  			<tr>
					  				...
					  				<td width="59%" align="center">
					  				  <input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" class="inputBorder2" style="width:66%;float:left" id="eLogicalCircuitId" name="eLogicalCircuitId" />
					  				</td>	
					  			</tr>
					  			<tr>
					  			    <td width="41%" align="left"><b>E2.InfraOrderno</b></td>
					  				<td width="59%" align="center">
					  				  <input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" class="inputBorder2" style="width:66%;float:left" id="InfraOderNo" name="InfraOderNo" />
					  				</td>
					  			</tr>
					  			<tr>
					  			    <td width="41%" align="left"><b>E3.Metasolv Circuit id</b></td>
					  			      <td width="59%" align="center">
					  				  <input onmouseover='getTip(value)' onmouseout='UnTip()' type="text" class="inputBorder2" style="width:66%;float:left" id="metasolvCircuitId" name="metasolvCircuitId"/>
					  				</td>
					  			</tr>
					  		</table>
				  		</fieldset>
