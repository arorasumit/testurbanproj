...
<html:form action="/NewOrderAction" styleId="state" method="post">
   ...
   <table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="tab2" >
			   <tr class="normal">
					...
					<div style="float:left;"><strong>State Name:</strong><input type="text" id="txtState" name="state" class="inputBorder1" maxlength="25" onkeydown="if (event.keyCode == 13)  return isBlankFields();" >
					</div></td>
					<td>
