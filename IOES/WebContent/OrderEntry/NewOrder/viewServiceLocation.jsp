...
<body>
	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0" id="tblServiceLocationDetails" style="display: none;">
		...
		<tr>
			<td width="25%">
				Please Select Type
				<select onmouseover="getTip_DD(this,this.selectedIndex,this.id)"  name="ddPrimaryLocType" id="ddPrimaryLocType" class="dropdownMargin" onchange="selectPrimaryLocation(1,null)"  isRequired="0">
					<option value="0" title="Select Type">Select Type</option>
			...
			<td width="25%" id ="allLoc">
				...
				<select onmouseover="getTip_DD(this,this.selectedIndex,this.id)"  name="ddSecondaryLocType" id="ddSecondaryLocType" class="dropdownMargin" onchange="selectSecondaryLocation(1, null)" isRequired="0">
			...
			<!--	Please Select a Type
				<select onfocus="getTip_DD(this,this.selectedIndex,this.id)"  name="ddSecondaryLocType" id="ddSecondaryLocType" style="width:85%;float:right" class="dropdownMargin" onchange="selectSecondaryLocation()" isRequired="1" >
					...
					<table width="100%"  border="0" cellspacing="2" cellpadding="0" style="table-layout: fixed;">
						<tr>
							...
							<!--     Select Customer Location  commented lawkush
								<select onmouseover="getTip_DD(this,this.selectedIndex,this.id)"  name="ddPrimaryBCP" id="ddPrimaryBCP"  style="width:80%;float:right" class="dropdownMargin" onchange="FetchPriBCPDetails()" isRequired="0">
									<option value="0" title="Select Installation Address">Select Installation Address</option>
								</select>
								...
								<!--   Auto suggest Customer location end lawkush  -->
							</td>
						</tr>
						<tr>
							<td width="20%" align="left">
					...
					<table width="100%"  border="0" cellspacing="2" cellpadding="0" style="table-layout: fixed;">
						<tr>
							...
							<!-- Lawkush 30 Jan Secondary Location Start 
								<select onmouseover="getTip_DD(this,this.selectedIndex,this.id)"  name="ddSecondaryBCP" id="ddSecondaryBCP"  style="width:85%;float:right" class="dropdownMargin" onchange="FetchSecBCPDetails()" isRequired="0">
			...
			<td width="100%" colspan="2">	
				...
				<table width="100%"  border="0" cellspacing="2" cellpadding="0">
					<tr>
						...
						<td width="80%">
							<input onmouseover="getTip(value)" onmouseout="UnTip()" type="text" class="inputBorder" isRequired="0" style="width:80%;float:right" name="txtToAddress" value="" maxlength="25" isRequired="0" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'From Address')};">
						</td>
					</tr>
				</table>
				</fieldset>
