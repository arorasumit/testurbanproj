		...
		<tr class="lightBgWihtoutHover">
			<td width="80%" align="left" valign="top">
				...
				<tr class="<%=classType%>">
					...
					<td align="center">		
					<logic:equal value="Change" property="stageName" name="List">				
						<a href="javascript:fnViewChangeOrder('<bean:write name="List" property="poNumber" />');">
							<font color="Brown">                       
					...
					<logic:notEqual value="Change" property="stageName" name="List">				
