...
function DrawCountryList()
{
	...
	var colors=new Array("normal","lightBg");
	 ...
	 for (i = 0; i <  lstService.list.length; i++)
	 {
	 	...
	 	{
	 		getInfoAndUpdate(escape(lstService.list[i].countyName),escape(lstService.list[i].countyCode));
	 	}*/	
...
<html:form action="/NewOrderAction" styleId="country" method="post">
   ...
   <table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" class="tab2" >
			   <tr class="normal">
					...
					<div style="float:left;"><strong>Country Name:</strong><input type="text" id="txtCountry"  name="country" class="inputBorder1" maxlength="25" onkeydown="if (event.keyCode == 13)  return isBlankFields();">
					</div></td>
					<td>
