...
<!--[002]	 ANIL KUMAR	    14-feb-2011 				Annotation field added in charges section against charges name -->
<!--[003]	 Rohit Verma	17-feb-2011 				Logic Start Date and End Date Label Changed -->
<!--[004]	 ANIL KUMAR		26-feb-2011 				fetch Charge Type RC/NRC based on bill format for hardware in charge section-->
<!--[005]	 ANIL KUMAR 	08-march-2011				Start date logic and End date logic should be default in charge section-->
<!--[006] 	 ANIL KUMAR 	09-march-2011				display Tax Rate in charge section-->
...
//	var account = parseInt(document.getElementById('hdnPOAccount').value);
	...
	str="<select onfocus='getTip_DD(this,this.selectedIndex,this.id)' style='width:175px' name='ddCType' id='ddCType"+idCounter+"' isRequired='0' Disp='' class='dropdownMargin' onchange='fillChargeNames("+idCounter+",this.value);changeFrequency("+idCounter+");calculateFreqAmount("+idCounter+");fillEndDateLogic("+idCounter+");'><option value='-1'>Select a Type</option></select>";
	...
	{	
		...
		var local_typeCombo = document.getElementById("ddCType"+idCounter);
	...
	str="<select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' style='width:175px' name='txtCName' id='txtCName"+idCounter+"' isRequired='0' Disp='' onchange='fillAnnotation("+idCounter+");getLineNSublineItemLbl("+idCounter+");getTaxRate("+idCounter+");' class='dropdownMargin'><option value='-1'>Select Name</option></select>";
	str=str+"<input type='hidden' name='hdnChargeName' value=''>";
	//[012] Start
	str=str+"<input type='hidden' name='hdnFxChargeID' id='hdnFxChargeID"+idCounter+"'>";
	//[012] End
	//str=str+"<input type='hidden' name='txtCNameID' id='txtCNameID"+idCounter+"'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	if(document.getElementById('hdnHardwareInfo').value==1)
	{
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' isRequired='0' Disp='' class='inputBorder1' name='txtCAnnotation' id='txtCAnnotation"+idCounter+"' onblur=\"if(this.value.length > 0){if(CheckMinLength(this)){return ValidateTextField(this,path,'Annotation')}}\" maxlength='240'>";
	}
	else
	{
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' isRequired='0' Disp='' class='inputBorder1' name='txtCAnnotation' id='txtCAnnotation"+idCounter+"' onblur=\"if(this.value.length > 0){if(CheckMinLength(this)){return ValidateTextField(this,path,'Annotation')}}\" maxlength='340'>";
	}
	//[013] End
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' isRequired='0' Disp='' class='inputBorder' name='txtTaxRate' id='txtTaxRate"+idCounter+"' readonly='true'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;		
	//end [006]
	...
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' isRequired='0' Disp='' maxlength='4' class='inputBorder1' name='txtCPeriod' id='txtCPeriod"+idCounter+"' value='"+contractPeriod+"' onblur='if(this.value.length > 0){if(checkdigits(this)){checkContractPeriod("+idCounter+");}else{return false;}}'>";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' isRequired='0' Disp='' maxlength='4' class='inputBorder1' name='txtCPeriod' id='txtCPeriod"+idCounter+"' value='"+contractPeriod+"'  onblur='if(this.value.length > 0){if(checkdigits(this)){fillFrequency("+idCounter+");}else{return false;}}'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	//str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder1' maxlength='15' name='txtCTAmt' id='txtCTAmt"+idCounter+"' onkeyup='if(this.value.length > 0){if(checknumber(this)){calculateFreqAmount("+idCounter+");}else{calculateFreqAmount("+idCounter+");return false;}}'  > ";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder1' maxlength='15' name='txtCTAmt' id='txtCTAmt"+idCounter+"'  oldvalue='' onkeyup='if(this.value.length > 0){if(checknumber_max2decimal_charges_section(this,0)){this.oldvalue=this.value;calculateFreqAmount("+idCounter+");calculateTotalLineAmount(this.value,"+chargeSumCounter+");}else{this.value=this.oldvalue;calculateFreqAmount("+idCounter+");calculateTotalLineAmount(this.value,"+chargeSumCounter+");return false;}}else{this.oldvalue=this.value;calculateTotalLineAmount(this.value,"+chargeSumCounter+");return false;}' onblur='if(this.value.length > 0){if(checknumber_max2decimal_charges_section(this,1)){this.oldvalue=this.value;calculateFreqAmount("+idCounter+");calculateTotalLineAmount(this.value,"+chargeSumCounter+");}else{this.value=this.oldvalue;calculateFreqAmount("+idCounter+");calculateTotalLineAmount(this.value,"+chargeSumCounter+");return false;}}else{this.oldvalue=this.value;calculateTotalLineAmount(this.value,"+chargeSumCounter+");return false;}'  > ";
	...
	str="<select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' style='width:175px' name='txtCFrequency' id='txtCFrequency"+idCounter+"' Disp='' isRequired='0' class='dropdownMargin' disabled='true' onchange='calculateFreqAmount("+idCounter+");' ><option value='-1'>Select a Frequency Type</option></select>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	
	fillFrequency(idCounter);
	
	var tblcol=tblRow.insertCell();
	tblcol.align = "left";
	tblcol.vAlign="top";
	tblcol.className="innerdata col9";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px' class='inputDisabled' Disp='' isRequired='0' name='txtCFreqAmt' id='txtCFreqAmt"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}' readonly='readonly'> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	str="<table><tr><td><select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' name='txtCStartDate' id='txtCStartDate"+idCounter+"' isRequired='0' Disp='' class='dropdownMargin' style='width:125px'><option value='-1' title='Select Start Date Logic'>Select Start Date Logic</option><option value='BTD' title='Billing Trigger'>Billing Trigger</option></select></td> ";
	str= str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtStartDays'  id='txtStartDays"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'></td> ";
	str= str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtStartMonth' id='txtStartMonth"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'><input type='hidden' name='hdnstartdate' value=''></td></tr></table> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.align = "left";
	tblcol.vAlign="top";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtStartDays'  id='txtStartDays"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.align = "left";
	tblcol.vAlign="top";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtStartMonth' id='txtStartMonth"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'><input type='hidden' name='hdnstartdate' value=''>";
	CellContents = str;
	tblcol.innerHTML = CellContents;*/
	...
	tblcol.vAlign="top";
	tblcol.className="innerdata col4";
	str="<table><tr><td><select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' name='txtCEndDate' id='txtCEndDate"+idCounter+"' isRequired='0' Disp='' class='dropdownMargin' onchange='changeEndDays("+idCounter+");' style='width:125px'><option value='-1' title='Select End Date Logic'>Select End Date Logic</option></select></td> ";
	str= str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtEndDays' id='txtEndDays"+idCounter+"'  onblur='if(this.value.length > 0){return checknumber(this)}'></td> ";
	str= str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtEndMonth' id='txtEndMonth"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'></td></tr></table> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.align = "left";
	tblcol.vAlign="top";
	str="<input type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtEndDays' id='txtEndDays"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.align = "left";
	tblcol.vAlign="top";
	str="<input type='text' style='width:100px;' value='0'  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtEndMonth' id='txtEndMonth"+idCounter+"' onblur='if(this.value.length > 0){return checknumber(this)}'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;*/
	...
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' value=''  isRequired='0' Disp='' maxlength='4' class='inputBorder' name='txtAnnualCharge' id='txtAnnualCharge"+idCounter+"'  readonly='readonly'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	//<!-- End   [009] -->
	...
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' name='cmbLineItem' style='display:none;width:175px;' id='cmbLineItem"+idCounter+"' isRequired='0' Disp=''  class='dropdownMargin'><option value='-1'>Select Line Item</option></select>";
	str=str+"<input type='hidden' name='hdnChargeName' value=''>";
	str=str+"<label id='lineItemLbl"+idCounter+"'> &nbsp; </label> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	fillLineItem(idCounter);
	var tblcol=tblRow.insertCell();
	tblcol.align = "center";
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<select onmouseover='getTip_DD(this,this.selectedIndex,this.id)' name='cmbSubLineItem' style='display:none;width:175px;' id='cmbSubLineItem"+idCounter+"' isRequired='0' Disp=''  class='dropdownMargin'><option value='-1'>Select Sub Line Item</option></select>";
	//str=str+"<input type='hidden' name='hdnChargeName' value=''>";
	str=str+"<label id='subLineItemLbl"+idCounter+"'> &nbsp; </label> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	fillSubLineItem(idCounter);
	//End [000777]30 JAN
	//Start [010]
	var tblcol=tblRow.insertCell();
	tblcol.align = "left";
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' value=''  isRequired='0' Disp='' maxlength='300' class='inputBorder' name='txtRemarks' id='txtRemarks"+idCounter+"' onBlur=\"if( trim(this.value).length>0){return ValidateTextField(this,path,'Remarks')};\">";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' value=''  isRequired='0' Disp='' maxlength='50' class='inputBorder' name='txtChargeStartDate' id='txtChargeStartDate"+idCounter+"'  readonly='readonly'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	tblcol.vAlign="top";
	tblcol.className="innerdata col3";
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' value=''  isRequired='0' Disp='' maxlength='50' class='inputBorder' name='txtChargeEndDate' id='txtChargeEndDate"+idCounter+"'  readonly='readonly'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	//End [010]
	...
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' name='chkexcludeCharges' id='chkexcludeCharges"+idCounter+"' type='checkbox'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	...
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:90px;' value=''  isRequired='0' Disp='' maxlength='10' class='inputBorder' name='txtLDDateClause' id='txtLDDateClause"+idCounter+"' readonly='true'><img src='<%=request.getContextPath()%>/images/cal.gif' border='0px' alt='Loading...' onclick=\"javascript:show_calendar(productCatelog.txtLDDateClause" + idCounter + ");\" style='vertical-align: bottom'/></font>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	var tblcol=tblRow.insertCell();
	tblcol.align = "left";
	...
	str="<input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:50px;' value=''  isRequired='0' Disp='' maxlength='2' class='inputBorder' name='txtDelayedTimeInDays' id='txtDelayedTimeInDays"+idCounter+"' onblur='if(this.value.length > 0){if(checkdigitsValidation(this)){checkUperLimit(this.value,this.id,30,"+idCounter+");}else {return false;}}'>";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	var tblcol=tblRow.insertCell();
	tblcol.align = "left";
	tblcol.vAlign="top";
	tblcol.className="innerdata col13";
	str = "<table><tr><td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:50px;' value=''  isRequired='0' Disp='' maxlength='3' class='inputBorder' name='txtLDPercentage' id='txtLDPercentage"+idCounter+"' onblur='if(this.value.length > 0){if(checkdigitsValidation(this)){checkUperLimit(this.value,this.id,100,"+idCounter+");}else {return false;}}'></td>";
	str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:50px;' value=''  isRequired='0' Disp='' maxlength='3' class='inputBorder' name='txtMaxPenaltyPercentage' id='txtMaxPenaltyPercentage"+idCounter+"' onblur='if(this.value.length > 0){if(checkdigitsValidation(this)){checkUperLimit(this.value,this.id,100,"+idCounter+");}else {return false;}}'></td></tr></table> ";
	CellContents = str;
	tblcol.innerHTML = CellContents;
	//End Billing Efficiency
	//[011] Start -- Payment Term Mandatory for both Hardware and Services hence only one Payment Terms Tag is Required for the same
	//if(document.getElementById('hdnHardwareInfo').value==1)
	//{		
		var tblcol=tblRow.insertCell();
		tblcol.align = "left";
		...
		str = "<table><tr><td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment1' id='txtPayment1"+idCounter+"' onblur='if(this.value.length > 0){checkdigits(this)}' ></td>";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment2' id='txtPayment2"+idCounter+"' onblur='if(this.value.length > 0){checkdigits(this)}'   ></td> ";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment3' id='txtPayment3"+idCounter+"' onblur='if(this.value.length > 0){checkdigits(this)}'  ></td> ";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment4' id='txtPayment4"+idCounter+"' onblur='if(this.value.length > 0){checkdigits(this)}'  ></td></tr></table> ";
		CellContents = str;
		tblcol.innerHTML = CellContents;
	//}
	/*else
	{
		...
		tblcol.vAlign="top";
		tblcol.className="innerdata col12";
		str = "<table><tr><td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment1' id='txtPayment1"+idCounter+"' readonly='readonly'  ></td>";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment2' id='txtPayment2"+idCounter+"' readonly='readonly' ></td> ";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment3' id='txtPayment3"+idCounter+"' readonly='readonly' ></td> ";
		str = str + "<td><input onmouseover='getTip(value)' onmouseout='UnTip()' type='text' style='width:175px;' isRequired='0' Disp='' class='inputBorder' name='txtPayment4' id='txtPayment4"+idCounter+"' readonly='readonly' ></td></tr></table> ";
		CellContents = str;
		tblcol.innerHTML = CellContents;
	}*/
	//[011] End
	...
	ctrlArry[0] =  document.getElementById("ddCType"+idCounter);
	ctrlArry[1] =  document.getElementById("txtCName"+idCounter);
	ctrlArry[2] =  document.getElementById("txtCPeriod"+idCounter);
	ctrlArry[3] =  document.getElementById("txtCTAmt"+idCounter);
	ctrlArry[4] =  document.getElementById("txtCFrequency"+idCounter);
	ctrlArry[5] =  document.getElementById("txtCFreqAmt"+idCounter);
	ctrlArry[6] =  document.getElementById("txtCStartDate"+idCounter);
	ctrlArry[7] =  document.getElementById("txtCEndDate"+idCounter);
	ctrlArry[8] =  document.getElementById("txtCAnnotation"+idCounter);
	ctrlArry[9] =  document.getElementById("txtAnnualCharge"+idCounter);
	ctrlArry[10] =  document.getElementById("txtRemarks"+idCounter);
	//ctrlArry[11] =  document.getElementById("cmbLineItem"+idCounter);
	//ctrlArry[12] =  document.getElementById("cmbSubLineItem"+idCounter);
	...
	//start [005]
	document.getElementById("txtCStartDate"+idCounter).selectedIndex=1;
	// document.getElementById("txtCEndDate"+idCounter).selectedIndex=2;
	//end [005]
//	fillEndDateLogic(idCounter);
...
function formulaFreqAmt(index)
{
	...
	//document.getElementById("txtCFreqAmt"+index).value=Math.round(frqAmount);
