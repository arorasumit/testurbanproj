...
<script type="text/javascript">
	...
	function ValidateFields()
	{
		 ...
		 if(ValidateTextField(myform.taskrejectComments,'<%=request.getContextPath()%>',"Reject Task Comments")==false)
			return false;

		 if(chkDescriptionLength(myform.taskrejectComments.value,'Reject Task Comments')==false)
			return false;
	...
	function saveTask()
	{
		...
		if(ValidateFields()==false)
	 	...
	 	document.searchForm.action="<%=request.getContextPath()%>/MyToDoList.do?methodName=saveRejectTask";
	 	showLayer();
...
<html:form action="/MyToDoList" method="post" enctype="multipart/form-data" styleId="searchForm">
	...
	<html:hidden property="mainprojectid"/>
				...
				<tr>
					...
					<table align="center" cellSpacing="1" cellPadding="4" border="0"
						...
						<tr>
							...
							<td><html:textarea property="taskrejectComments" rows="6"
