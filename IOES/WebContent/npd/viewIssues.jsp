...
function pagingSubmit(val)
{
	...
	myform.action="<c:out value='${sessionScope.MenuContextPath}' />/issueCapture1.do?method=search";
	showLayer();
	myform.submit();
}
...
<html:form action="/issueCapture1" method="post" styleId="searchForm" onsubmit="return searchIssuesDetails();">
		...
		<tr valign="middle" id="newProduct">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td background="npd/Images/tabbg.gif" class="tabHeading" width="30%">View Issues</td>
					...
					<table width="50%" border="0">
						<tr>
							<td><html:submit property="method">
								<bean:message key="submit.onlysearch" bundle="ButtonResources" />
							</html:submit></td>
