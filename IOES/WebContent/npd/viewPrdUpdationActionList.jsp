...
function takeAction(var_projectId)
{
	var appContextPath = '<%=request.getContextPath()%>';
	jsonrpc = new JSONRpcClient(appContextPath + "/JSON-RPC");
	var_projectId = jsonrpc.processes.encryptString(var_projectId);
	var methodName;		
	methodName="initUpdateProductApproval";
	var da=new Date();
	...
	<tr valign="middle" id="newProduct">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td background="npd/Images/tabbg.gif" class="tabHeading" width="30%">Approve/Reject Project Updation</td>
...
<html:form action="/createProduct" method="post" styleId="searchForm">
	...
	<input type="hidden" name="method" value="initSearchUpdationAction"/>
					...
					<table align="center" cellSpacing="1" cellPadding="4" border="0"
						...
						<logic:iterate id="row"	name="formBean" property="filteredProjectList" indexId="index1">
								<tr class="<%=colors[index1.intValue()%2]%>">
									...
									<td>
										<a href="#" onclick="takeAction('<bean:write name='row' property='projectid' />');">
												Take Action
										</a>
									</td>
