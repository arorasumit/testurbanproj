...
{
	document.riskBean.action="<c:out value='${sessionScope.MenuContextPath}' />/riskCapture1.do?method=viewRisks&riskId="+var1;
	showLayer();
...
%>
<html:form action="/riskCapture1" method="post" styleId="searchForm"
	onsubmit="return searchRisksDetails();">
			...
			<table width="100%" border="0" class="tabledata" cellpadding="0"
					...
					<table width="50%" border="0">
						<tr>
							<td><html:submit property="method">
								<bean:message key="submit.onlysearchRisk" bundle="ButtonResources" />
							</html:submit></td>
				...
				<logic:notEmpty name="riskBean" property="riskDetailList">
					<table width="100%" border="1" class="tabledata" cellpadding="3"
						...
						<tr>
							<td colspan="17" class="tabledata"><bean:define
