...
//******************************************************************************
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #af0000;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #ffe2dd;'   +
                                        'color:             black;}'  +
            '/* Week number heading */'                                 +
            ...
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            'td.scwCells                {background-color:  #fff6f4;'   +
                                        'color:             #000000;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate            {background-color:  yellow;'   +
                                        'color:             #FF0000;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #fff6f4;'   +
                                        'color:             #CC6666;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #af0000;'   +
                                        'color:             #FFFFFF;'  +
                                        'font-size:         8pt;}'		+
            '/* Clear Button */'                                        +
