...
<div class="head"> <span>Edit Baselined Workflow</span> </div>
...
<html:form action="/createProduct" method="post" styleId="searchForm">
	...
	<input type="hidden" name="method" value="initSearchEditBaselinedPlan"/>
	...
	<table width="100%" border="1" class="tab2" cellpadding="3" cellspacing="1" align="center">
			...
			<table cellSpacing="0" cellPadding="0" width="100%" border="0" id="tbl1" class="tab2" style="display:block" align="center">	
						<tr class="grayBg">
							...
							<td align="center">iB2B Workflow Category</td>							
							<td align="center">Attach/Edit Project Workflow</td>							
							<td align="center">View Versions</td>	
						</tr>
						<tr class="lightBgWihtoutHover">
							...
							<th width="5%"  >
							<html:select property="searchNpdCategoryId" styleClass="inputBorder1" onchange="searchSubmit();">
						...
						%>	
								<tr class="<%=classType%>">
									...
									<td>
									<font color="brown">
										<logic:equal name="row" property="isactive" value="2">
											<a href="#" onclick="attachEditPlan('workOnDraft','<bean:write name='row' property='projectid' />');">
													Work on Draft
											</a>
										</logic:equal>
										<logic:equal name="row" property="isactive" value="1">
												<a href="#" onclick="attachEditPlan('openAsDraft','<bean:write name='row' property='projectid' />');">
														Open Current In Draft
												</a>
										</logic:equal>	
									</font>
									</td>
									...
									<logic:equal name='row' property='projectCurrentVersion' value="1" >
										<bean:write name='row' property='projectCurrentVersion' />.0
									</logic:equal>
