...
function updateIssue(var1)
{
	...
	*/	
	document.assumptionBean.action="<c:out value='${sessionScope.MenuContextPath}' />/assumptionCapture.do?method=viewAssumption&assumptionId="+var1;
	showLayer();
	document.assumptionBean.submit();
}
...
function pagingSubmit(val)
{
	...
	myform.action="<c:out value='${sessionScope.MenuContextPath}' />/assumptionCapture.do?method=search";
	myform.submit();
}
...
<br>
<html:form action="/assumptionCapture" method="post"  styleId="searchForm"
		...
		<tr>
			...
			<table width="100%" border="0" class="tabledata" cellpadding="0"
				...
				<tr>
					...
					<td align="right"><a
						href="assumptionCapture.do?method=viewAssumption">Add New
					Assumption</a></td>
				</tr>
					...
					<table width="50%" border="0">
						<tr>
							<td><html:submit property="method">
								<bean:message key="submit.searchAssumpion"
							...
							<c:if test="${index1%2==0}">
								<tr class="redBg" align="center">
									...
									<td style="width:50"><a href="#"
										onclick="updateIssue(<bean:write name='assumptionDetailList_id' property='projassumid' />);">Edit</a></td>
								</tr>
							</c:if>
							<c:if test="${index1%2!=0}">
