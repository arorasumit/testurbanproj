...
<%if(!"viewHist".equalsIgnoreCase(request.getParameter("spPage"))){ %>
...
<table class="tab2" align="center"><tr><td>
...
<html:form action="/masterPlanVersion" method="post" styleId="myform">	
				...
				<tr align="center">
					...
					<table width="50%" border="0">
						<tr>
							<td>
							<!--<span
								id="saveButton" property="method" class="buttonLarge">View History</span>-->
						...
						<logic:notEmpty property="taskList" name="masterProjectPlanBean">							
							<table width="80%" border="1" class="tab2" cellpadding="3"
								...
								<logic:iterate id="masterProjectPlanBean_id"
									name="masterProjectPlanBean" property="taskList"
									indexId="index1">

									<c:if
										test="${masterProjectPlanBean_id.stagehistoryid.workflowhistoryid.id!=workflowId}">
										<c:set var="sno" value="${sno+1}"></c:set>
										<c:set var="workflowId"
											value="${masterProjectPlanBean_id.stagehistoryid.workflowhistoryid.id}"></c:set>
								...
								<logic:iterate id="masterProjectPlanBean_id"
									...
									<c:if
										...
										<tr class="normal">
											...
											<c:out value="Version ${sno}.0" /></td>
											<c:set var="sno" value="${sno-1}" />
											<td><bean:write name="masterProjectPlanBean_id"
												property="stagehistoryid.workflowhistoryid.workflowname" /></td>
									...
									<tbody id="tbl${sno+1}.${counter}" style="display:none">
										<c:if
											test="${masterProjectPlanBean_id.stagehistoryid.stageid!=stageId}">
											...
											<c:set var="stageId"
												value="${masterProjectPlanBean_id.stagehistoryid.stageid}"></c:set>
										...
										<tr class="lightBg">
											...
											<td width="40%" nowrap="nowrap"><bean:write name="masterProjectPlanBean_id"
												property="stakeholder.rolename" /></td>
