...
function fnUpdate(){
		...
		document.forms[0].action="<%=request.getContextPath()%>/productAttributes.do?method=updateProductAttributes";
...
function displayAttributeList()
{
	...
	myForm.action="<%=request.getContextPath()%>/productAttributes.do?method=getServiceTypeList";
...
function fetchProductList()
{
	...
	myForm.action="<%=request.getContextPath()%>/productAttributes.do?method=getProductTypeList";

    myForm.submit();

}
function fetchProductAttributeList()
{

	var myForm = document.getElementById('searchForm');
	
	var serviceDetailId=document.getElementById("productList1").value;
	myForm.hiddenServiceDetailId.value=serviceDetailId;
	
	myForm.action="<%=request.getContextPath()%>/productAttributes.do?method=getProductAttributeList";
...
<body onload="bodyLoad()">
	<html:form action="/productAttributes" styleId="searchForm" method="post">
	<bean:define id="formBean" name="masterAttributesBean"></bean:define>
	<html:hidden property="hiddenServiceTypeId"/>
	<html:hidden property="hiddenServiceDetailId"/>
...
<table width="100%"   border="0" cellspacing="0" cellpadding="0" align="center" id='tblAttributesList'>
	...
	<tr>
	<td>
		<fieldset class="border2" style="width:97%;"><legend> <b>Product Attribute Details</b>
			</legend>
			<br>
			...
			<table border="0" cellspacing="0" cellpadding="0" style="margin-top:7px " width="100%">
				...
				<html:select property="serviceList" styleId="serviceList1" styleClass="inputBorder1" style="width:150px;" onchange="javascript:fetchProductList();">
				...
				<tr>
				<td align="right" style="font-size:9px" width="50%">Select Product Type</td>
				<td align="left" style="font-size:9px" width="50%">
				<html:select property="productList" styleId="productList1" styleClass="inputBorder1" style="width:150px;" onchange="javascript:fetchProductAttributeList();">
					<html:option value="0">--- Select ---</html:option>
					<html:optionsCollection name="masterAttributesBean" property="products"  value="serviceDetailId" label="serviceDetailType"></html:optionsCollection>
				</html:select>
				</td>
				</tr>
					...
					<table cellpadding="0" align="center" cellspacing="0" class="tab2" width="100%" border="1" >
						...
						<%
						 ...
						 <tr class="<%=classType %>">
							...
							<td>&nbsp; <html:select name="row" disabled="true"  property="attDataType" styleId="attDataType_1" styleClass="inputBorder1" style="width:110px;" >
								<html:option value="0">--- Select ---</html:option>
