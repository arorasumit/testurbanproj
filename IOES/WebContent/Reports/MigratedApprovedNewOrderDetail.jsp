...
function pagingSubmit(val)
{
	...
	myform.method.value='viewMigAppNewOrderDetails';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewMigAppNewOrderDetails";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewMigAppNewOrderDetails&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}	
}
...
<div id="shadow" class="opaqueLayer"><font color="yellow" size="6"> Please wait..</font></div>
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"><table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>MIGRATED APPROVED NEW ORDER DETAILS</span> 
			</td>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<legend> <b>Migrated Approved New Order Details</b></legend>
			<br/>
			<table width="100%">
				<tr>
					<td>
			...
			<!-- Start Scrolling and Freezing of MigAppNewOrderReport-->
			<table border="0" cellpadding="0" cellspacing="0" class='main'>
					...
					<logic:present name="MigAppNewOrderDetailsList" scope="request">
							...
							<logic:empty  name="MigAppNewOrderDetailsList" scope="request">
								Order Number
									...
									<td class='inner col3 head1'><b>Order Month</b></td>
									...
									<td class='inner col3 head1'><b>Bl Source</b></td>					
									...
									<td class='inner col3 head1'><b>Opms_LineItemNumber</b></td>
				</tr>
							</table>
						</div>
						<div id='contentscroll' class='content1' onscroll='reposHead(this);'style="height: ">
							<table border="0" cellpadding="0" cellspacing="0" class='content1' id='tableMigAppNewOrderReport'>
				<logic:present name="MigAppNewOrderDetailsList" scope="request">
					<logic:notEmpty  name="MigAppNewOrderDetailsList" scope="request"> 					
						<logic:iterate id="row" name="MigAppNewOrderDetailsList" indexId="recordId">
							...
							<tr class="<%=classType%>">
												...
												<td align="left" class='inner col3'><bean:write  name="row" property="ordermonth"/>&nbsp;</td>
												...
												<td align="left" class='inner col3'><bean:write  name="row" property="totalPoAmt"/>&nbsp;</td><!--Cust Tot Po Amt-->
												...
												<td align="left" class='inner col3'><bean:write  name="row" property="billingtrigger_createdate"/>&nbsp;</td><!-- Bill Trg Create Date -->							
												...
												<td align="left" class='inner col3'><bean:write  name="row" property="blSource"/>&nbsp;</td>
												<td align="left" class='inner col3'><bean:write  name="row" property="business_serial_n"/>&nbsp;</td><!-- Business Serial No	-->
												<td align="left" class='inner col3'><bean:write  name="row" property="opms_Account_Id"/>&nbsp;</td><!-- Opms Account Id -->	
				...
				<tr>
	               	<td colspan="3">
	                   	<div class='horizontal-scrollMigAppNewOrderReport' onscroll='reposHorizontal(this);'>
	                       	<div>
	                       	</div>
	                   	</div>
	               	</td>
			...
			<!-- End Scrolling and Freezing of MigAppNewOrderReport-->		
		</fieldset>
	</html:form>
</body>
</html>
