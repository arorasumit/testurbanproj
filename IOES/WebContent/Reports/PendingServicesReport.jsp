<!-- [001] Gunjan Singla     added verticalDetails, currencyName-->
...
<html>
<head>
<title>Pending Services Report</title>
...
function pagingSubmit(val)
{
	...
	myform.method.value='viewPendingServicesReport';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewPendingServicesReport";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewPendingServicesReport&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}
}
	...
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<table border="0" align="center" cellpadding="0" cellspacing="0" width="98%">
			...
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>PENDING SERVICES REPORT</span>  
			</td>
		...
		<fieldset border="1" align="center" class="border2" >
			<legend> <b>Pending Services Report</b></legend>
			<br/>
			<table width="100%">
				<tr>
					<td>
			...
			<!-- Start Scrolling and Freezing of PENDING SERVICES REPORT  -->
			<table border="0" cellpadding="0" cellspacing="0" class='main'>       
			 	<tr>
					...
					<td align="center" class='inner col2 head1'><b>Account Name</b></td>
					...
					<logic:present name="pendingServicesReportList" scope="request">
							...
							<logic:empty  name="pendingServicesReportList" scope="request">
								...
								<td align="center" class='inner col2 head1'><b>Vertical Details</b></td>		
								<td align="center" class='inner col2 head1'><b>Currency Name </b></td>
				...
				<logic:present name="pendingServicesReportList" scope="request">
					<logic:notEmpty  name="pendingServicesReportList" scope="request"> 					
						<logic:iterate id="row" name="pendingServicesReportList" indexId="recordId">
							<%
							...
							<tr class="<%=classType%>">
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="party_no"/></td>
											...
											<td align="left" class='inner col3'><bean:write  name="row" property="billingStatus"/>&nbsp;</td>
											...
											<td align="left" class='inner col3'><bean:write  name="row" property="circuitStatus"/>&nbsp;</td>
											...
											<td align="left" class='inner col3'><bean:write  name="row" property="standardReason"/>&nbsp;</td>
											...
											<td align="left" class='inner col2'><bean:write  name="row" property="serviceIdString"/>&nbsp;</td>
		   		...
		   		<tr>
		          	<td colspan="3">
		              	<div class='horizontal-scrollpendingservicerport' onscroll='reposHorizontal(this);'>
		                  	<div>
		                  	</div>
		              	</div>
		          	</td>
		     ...
		     <!-- End Scrolling and Freezing of PENDING SERVICES REPORT   -->	
					<logic:empty  name="pendingServicesReportList">
