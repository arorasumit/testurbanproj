...
[002] Priya Gupta  28-Jan-2016	Added 3 new columns 
...
<html>
<head>
<title>OB Value Report(Usage)</title>
...
function pagingSubmit(val)
{
	...
	myform.method.value='viewOBValueReport_Usage';	
	showLayer();
	myform.submit();
}
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewOBValueReport_Usage";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewOBValueReport_Usage&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}
}
	...
	<html:form action="/reportsAction_Usage" styleId="searchForm" method="post">
		...
		<div border="1" class="head">
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"> <span>OB VALUE REPORT(USAGE)</span></td>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<table border="0" cellpadding="0" cellspacing="0" class='main'>
						...
						<div id='headscroll' class='divhead'>
							<table border="0" cellpadding="0" cellspacing="0" class='head1'>
								<tr>
									...
									<td class='inner col3 head1'><b>Component Name</b></td>
									<td class='inner col11 head1'><b>Component Id</b></td>
									...
									<td class='inner col4 head1'><b>Days</b></td>
									...
									<td class='inner col3 head1'><b>Project Category</b></td>
								<!--	<td class='inner col3 head1'><b>Remarks for Service</b></td>  This column should be hidden temporary -->
									...
									<!-- <td class='inner col2 head1'><b>Partner Id</b></td> -->
									<!-- [002] end -->
									<!-- [003] start -->
									...
									<logic:notEmpty  name="OBValueReportList" scope="request"> 					
										<logic:iterate id="row" name="OBValueReportList" indexId="recordId">
											...
											<tr class="<%=classType%>">
												...
												<td align="left" class='inner col11'><bean:write name="row" property="componentID"/>&nbsp;</td>
												...
												<td align="left" class='inner col4'><bean:write  name="row" property="diffDays"/>&nbsp;</td>
												...
												<td align="left" class='inner col3'><bean:write  name="row" property="projectCategory"/>&nbsp;</td>
				...
				<tr>
					<td colspan="3">
						<div class='horizontal-scrollOBValueReport_Usage' onscroll='reposHorizontal(this);'>
							<div></div>
	                   	</div>
	               	</td>
				</tr>
