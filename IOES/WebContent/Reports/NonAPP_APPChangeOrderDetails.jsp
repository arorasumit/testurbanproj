...
function pagingSubmit(val)
{
	...
	myform.method.value='viewNonAppAppChangeOrderDetails';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewNonAppAppChangeOrderDetails";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewNonAppAppChangeOrderDetails&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}
}
	...
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> 
			...
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>NON APPROVED/APPROVED CHANGE ORDER DETAILS</span> 
			</td>
			...
			<legend><b>Search</b></legend>
				<table border="0"  align="center" style="margin-top:7px">
					...
					<tr>
						...
						<td align="left" nowrap>
							<html:select  property="serviceOrderType" >
								<html:option value="">SELECT</html:option>
							    ...
							    <html:option value="16">Demo Permanent Disconnection After Suspention</html:option>
							</html:select>
						</td>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<!-- Start Scrolling and Freezing of nonAppAppChangeOrderDetailsReport-->	
			<table border="0" cellpadding="0" cellspacing="0" class='main'>
					...
					<logic:present name="nonAppAppChangeOrderDetailsList" scope="request">
							...
							<logic:empty  name="nonAppAppChangeOrderDetailsList" scope="request">
								Order Number
									...
									<td class='inner col3 head1'><b>Opms LineItemNumber</b></td>
									<!-- Shourya end -->
						...
						<div id='contentscroll' class='content1' onscroll='reposHead(this);'style="height: ">
							<table border="0" cellpadding="0" cellspacing="0" class='content1' id='tableNonAppChangeOrderDetailsReport'>
				<logic:present name="nonAppAppChangeOrderDetailsList" scope="request">
					<logic:notEmpty  name="nonAppAppChangeOrderDetailsList" scope="request"> 					
						<logic:iterate id="row" name="nonAppAppChangeOrderDetailsList" indexId="recordId">
							...
							<tr class="<%=classType%>">
												...
												<!-- Shourya add few more columns -->
												<td align="left" class='inner col3'><bean:write  name="row" property="business_serial_n"/>&nbsp;</td>
							                                        <td align="left" class='inner col3'><bean:write  name="row" property="opms_Account_Id"/>&nbsp;</td>
							                                       <!-- Shourya End -->
				...
				<tr>
	               	<td colspan="3">
	                   	<div class='horizontal-scrollNonAppChangeOrderDetailsReport' onscroll='reposHorizontal(this);'>
	                       	<div>
	                       	</div>
	                   	</div>
	               	</td>
			...
			<!-- End Scrolling and Freezing of nonAppAppChangeOrderDetailsReport-->		
		</fieldset>
	</html:form>
</body>
</html>
