...
function pagingSubmit(val)
{
	...
	myform.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewNonMigAppUnappNewOrderDetails&usage="+isUsage;	
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewNonMigAppUnappNewOrderDetails&inExcel=true&usage="+isUsage;
		showLayerExcel();
		myForm.submit();
	}
}
...
function isBlankForm()
{
	...
	//if((orderType==null && fromOrderNo==null && toOrderNo==null && servicename == null && ordermonth == null && approvalType==null) 
	//	|| (trim(orderType)=="" && trim(fromOrderNo)=="" && trim(toOrderNo)=="" && trim(servicename) == "" && trim(ordermonth) == "" && trim(approvalType) == "")){
...
<html:hidden property="reportCurrentCount"/>
		...
		<div border="1" class="head"> <span>NON MIGRATED APPROVED/UNAPPROVED NEW ORDER DETAILS</span> </div>
		</logic:equal>
		<logic:equal name="isUsage" value="1">
			...
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>NON MIGRATED APPROVED/UNAPPROVED NEW ORDER DETAILS(USAGE)</span> 
			</td>
			...
			<legend><b>Search</b></legend>
				<table border="0"  align="center" style="margin-top:7px">
					...
					<tr>
						...
						<td align="left">
							<html:text  property="servicename" style="width:75px;float:left;" maxlength="18" onchange="if( trim(this.value).length>0){return ValidateTextField(this,path,'Service Name')};" ></html:text>
						</td>
						<td align="left">
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<tr>
				...
				<logic:equal name="isUsage" value="1">
					...
					<td align="center" class='inner col2 head1' width="20px"><b>Bandwidth</b></td>
				...
				<logic:present name="nonMigAppUnappNewOrderDetailsList" scope="request">
					<logic:notEmpty  name="nonMigAppUnappNewOrderDetailsList" scope="request"> 					
						<logic:iterate id="row" name="nonMigAppUnappNewOrderDetailsList" indexId="recordId">
							...
							<td align="left" class='inner col2'><bean:write  name="row" property="kmsDistance"/>&nbsp;</td>
							...
							<td align="left" class='inner col2'><bean:write  name="row" property="totalPoAmt"/>&nbsp;</td><!--Total Amount-->
			    ...
			    <td class='tableverticalscroll' rowspan="2">
			   	 ...
			   	 <tr>
		          	<td colspan="3">
		              	<div class='horizontal-scrollnonmigappunapporderreportusage' onscroll='reposHorizontal(this);'>
		                  	<div>
		                  	</div>
		              	</div>	
		          	</td>
		     	 ...
		     	 <!-- End Scrolling and Freezing of NON MIG APP/UNAPP NEW ORDER DETAILS Usage    -->
