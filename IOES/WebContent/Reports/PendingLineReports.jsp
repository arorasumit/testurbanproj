...
<!-- Vijay    27Lune-2013   Create a new report Pending Line Report -->
<!-- [001] Gunjan Singla     added  jsonrpc populatereportusagedetails method-->
<!-- [BFR4] Nagarjuna        GlobalDataBillingEfficiency Project to add TaxExemptionReason -->
<%-- [002]   Neha Maheshwari    04-Dec-2014   CSR20141014-R2-020535-Service Segment Configuration-SMB --%>
<!-- [003] Neha Maheshwari    14-Apr-15     CSR-20150212-R1-021088  Addition of Column in Active and Pending Line Item Reports -->
<%-- [004]   Neha Maheshwari 07-Sep-2015 20150819-XX-021651 TimeStamp Reports --%>
<!-- [005] Gunjan Singla 6-May-16   20160418-R1-022266  Added columns -->
...
<html>
<head>
<title>Pending Line Report</title>
...
function pagingSubmit(val)
{
	...
	myform.method.value='viewPendingLineReport';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewPendingLineReport";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewPendingLineReport&inExcel=true";
			showLayerExcel();
		myForm.submit();
	}
}
	...
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> 
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>Pending Line Report</span> 
			</td>
		...
		<fieldset border="1" align="center" class="border2" >
			<legend> <b>Pending Line Report</b></legend>
			<br/>
			<table width="100%">
				<tr>
					<td>
			...
			<!-- Start Scrolling and Freezing of Pending Line Report   -->
			<table border="0" cellpadding="0" cellspacing="0" class='main'>       
	                	  ...
	                	  <table border="0" cellpadding="0" cellspacing="0" class='head1'>
							<tr>
							   ...
							   <td align="center" class='inner col2 head1'><b>TaxExemption Reason</b></td>		
								...
								<td align="center" class='inner col2 head1'><b> Trg Create Date  </b></td>						
								...
								<td align="center" class='inner col2 head1'><b> 	
									<logic:present name="PendingLineReport" scope="request">
										<logic:notEmpty  name="PendingLineReport" scope="request"> 
											<a href="#" onclick="sortSubmit('ORDERNO')">Order Number</a>
										</logic:notEmpty>
										<logic:empty  name="PendingLineReport" scope="request">
											Order Number
										</logic:empty>
									</logic:present>
								</b></td>
				...
				<logic:present name="PendingLineReport" scope="request">
					<logic:notEmpty  name="PendingLineReport" scope="request"> 					
						<logic:iterate id="row" name="PendingLineReport" indexId="recordId">
							<%
							...
							<tr class="<%=classType%>">
								...
								<td align="left" class='inner col1'><bean:write  name="row" property="chargeTypeID"/>&nbsp;</td>
								...
								<td align="left" class='inner col1'><bean:write  name="row" property="creditPeriod"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="orderCreationDate"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="lineamtString"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="poAmountSumString"/>&nbsp;</td>
								<td align="left" class='inner col1'><bean:write  name="row" property="contractPeriod"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="totalAmountIncludingCurrentString"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="cust_total_poamtString"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="annual_rateString"/>&nbsp;</td>
       		...
       		<!-- End Scrolling and Freezing of Pending Line Report    -->
					<logic:empty  name="PendingLineReport">
