...
function pagingSubmit(val)
{
	...
	myform.method.value='viewBillingTriggerDoneButFailedInFX';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewBillingTriggerDoneButFailedInFX";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewBillingTriggerDoneButFailedInFX&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}
}
...
<body onload="javascript:maxLimitChecker(document.getElementById('searchForm'),'<%=ApplicationFlags.ReportsExcelMaxSize%>','<%=Messages.getMessageValue("ReportsExcelMaxSizeMessage") %>');">
	...
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>BILLING TRIGGER DONE BUT FAILED IN FX</span>  
			</td>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<!-- Start Scrolling and Freezing of Billing trigger done but failed in fx Report -->
				<table border="0" cellpadding="0" cellspacing="0" class='main'>       
					...
					<td align="center" class='inner col31 head1'><b>Contract Start Date</b></td>	
					<td align="center" class='inner col31 head1'><b>Contract End Date</b></td>	
					...
					<td align="center" class='inner col31 head1'><b>Dispatch Address</b></td>
					...
					<td align="center" class='inner col31 head1'><b>Warranty Start Date</b></td>
					<td align="center" class='inner col31 head1'><b>Warranty End Date</b></td>
					<td align="center" class='inner col31 head1'><b>Extnd Support End Date</b></td>
					...
					<!--<td align="center" class='inner col31 head1'><b>Order Type Id</b></td>-->
					<td align="center" class='inner col2 head1'><b>Service Order Type</b></td>
					<td align="center" class='inner col31 head1'><b>Service Order Type Desc</b></td>					
					...
					<td align="center" class='inner col31 head1'><b>Charge Type Id</b></td> 
					...
					<td align="center" class='inner col31 head1'><b>Token No Ed</b></td>
					<td align="center" class='inner col31 head1'><b>Fx Status Ed</b></td>
					...
					<td align="center" class='inner col31 head1'><b>Coll Manager</b></td>
					<td align="center" class='inner col31 head1'><b>Coll Mgr Mail</b></td>
					<td align="center" class='inner col31 head1'><b>Coll Mgr Ph</b></td>
					...
					<td align="center" class='inner col31 head1'><b>Charge Hdr Id</b></td>
				...
				<!--  	<td align="center" class='inner col2 head1'><b>Discount</b></td> -->
					...
					<td align="center" class='inner col2 head1'><b>Tot Po Amt</b></td>
					 <td align="center" class='inner col31 head1'><b>Party Id</b></td>
					 <td align="center" class='inner col31 head1'><b>Cust Account Id</b></td>
					 <td align="center" class='inner col31 head1'><b>M6 Product Id</b></td>
					 <td align="center" class='inner col31 head1'><b>M6 Order Id</b></td>
					...
					<td align="center" class='inner col31 head1'><b>Fx Sno</b></td>
					<td align="center" class='inner col31 head1'><b>Fx Sno Ed</b></td>
				...
				<logic:present name="billingTriggerDoneButFailedInFXList" scope="request">
					<logic:notEmpty  name="billingTriggerDoneButFailedInFXList" scope="request"> 					
						<logic:iterate id="row" name="billingTriggerDoneButFailedInFXList" indexId="recordId">
							...
							<td align="center" class='inner col2'><bean:write  name="row" property="logicalSINumber"/>&nbsp;</td>
							...
							<td align="center" class='inner col2'><bean:write  name="row" property="billPeriod"/>&nbsp;</td>
							...
							<td align="center" class='inner col31'><bean:write  name="row" property="endDate"/>&nbsp;</td>								
							<td align="center" class='inner col31'><bean:write  name="row" property="contractStartDate"/>&nbsp;</td>
							<td align="center" class='inner col31'><bean:write  name="row" property="contractEndDate"/>&nbsp;</td>
							...
							<td align="left" class='inner col31'><bean:write  name="row" property="dispatchAddressName"/>&nbsp;</td>
							...
							<td align="center" class='inner col2'><bean:write  name="row" property="billingLevelNo1"/>&nbsp;</td>
							...
							<td align="left" class='inner col31'><bean:write  name="row" property="secondaryLocation"/>&nbsp;</td>
							<td align="center" class='inner col31'><bean:write  name="row" property="ponum1"/>&nbsp;</td>
							...
							<td align="center" class='inner col31'><bean:write  name="row" property="party_no"/>&nbsp;</td>
							<td align="left" class='inner col4'><bean:write  name="row" property="chargeAnnotation"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="fxStatus"/>&nbsp;</td>
							<td align="left" class='inner col1'><bean:write  name="row" property="fx_St_Chg_Status"/>&nbsp;</td>
							...
							<td align="center" class='inner col31'><bean:write  name="row" property="LOC_Date"/>&nbsp;</td>
							...
							<td align="left" class='inner col31'><bean:write  name="row" property="childAccountFXSataus"/>&nbsp;</td>
							<td align="center" class='inner col31'><bean:write  name="row" property="warrantyStartDate"/>&nbsp;</td>
							<td align="center" class='inner col31'><bean:write  name="row" property="warrantyEndDate"/>&nbsp;</td>
							<td align="center" class='inner col31'><bean:write  name="row" property="extSuportEndDate"/>&nbsp;</td>
							...
							<!--<td align="left" class='inner col31'><bean:write  name="row" />&nbsp;</td> Order Type Id -->
							<td align="left" class='inner col2'><bean:write  name="row" property="ordersubtype"/></td><!-- Service Order Type -->
							<td align="left" class='inner col31'><bean:write  name="row" property="serviceStageDescription"/></td><!-- Service Order Type Desc -->
							<td align="center" class='inner col31'><bean:write  name="row" property="copcApproveDate"/>&nbsp;</td>	
							<td align="left" class='inner col31'><bean:write  name="row" property="billingtrigger_createdate"/></td><!-- Bill Trg Create Date -->
							<td align="left" class='inner col1'><bean:write  name="row" property="hardwareFlag"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="chargeTypeID"/></td>						
							...
							<td align="center" class='inner col31'><bean:write  name="row" property="orderDate"/>&nbsp;</td><!-- order creation Date -->
							<td align="center" class='inner col31'><bean:write  name="row" property="rfsDate"/>&nbsp;</td><!--Customer Service Rfs Date-->
							<td align="center" class='inner col31'><bean:write  name="row" property="poRecieveDate"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="tokenNoEd"/>&nbsp;</td><!--Token No Ed-->
							<td align="left" class='inner col31'>&nbsp;</td><!--Fx Status Ed-->
							...
							<td align="center" class='inner col2'><bean:write  name="row" property="fxSiId"/>&nbsp;</td>
							<td align="left" class='inner col2'><bean:write  name="row" property="cancelBy"/>&nbsp;</td>
							<td align="center" class='inner col2'><bean:write  name="row" property="canceldate"/>&nbsp;</td>
							...
							<td align="left" class='inner col31'><bean:write  name="row" property="coll_Manager"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="coll_Manager_Mail"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="coll_Manager_Phone"/>&nbsp;</td>
							...
							<td align="center" class='inner col2'><bean:write  name="row" property="orderNumber"/>&nbsp;</td>						
							<td align="left" class='inner col31'><bean:write  name="row" property="orderNumber"/>&nbsp;</td>		
							
							<td align="left" class='inner col31'><bean:write  name="row" property="charge_hdr_id"/>&nbsp;</td>
							...
							<td align="left" class='inner col31'><bean:write  name="row" property="party_id"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="accountID"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="m6_prod_id"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="m6_order_id"/>&nbsp;</td></td>
							<td align="left" class='inner col31'><bean:write  name="row" property="start_fx_no"/>&nbsp;</td>
							<td align="left" class='inner col31'><bean:write  name="row" property="end_fx_no"/>&nbsp;</td>
					...
					<tr>
	                	<td colspan="3">
	                    	<div class='horizontal-scrollbillingtriggerdonefailedfx' onscroll='reposHorizontal(this);'>
	                        	<div>
	                        	</div>
	                    	</div>
	                	</td>
				...
				<!-- End Scrolling and Freezing of Billing trigger done but failed in fx Report -->	
