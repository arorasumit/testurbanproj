...
<!-- []  Vijay    22-May-2013          Create a new report for cancel copy report with excel export facility   -->
...
function pagingSubmit(val)
{
	...
	myform.method.value='ViewCancelCopyReport';	
...
function searchClick()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=ViewCancelCopyReport";
		showLayer();
		myForm.submit(); 
	}
}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=ViewCancelCopyReport&inExcel=true";
			showLayerExcel();
		myForm.submit();
	}
}
...
function isBlankForm()
{
    ...
    if((fromDate == null & toDate == null) || ( trim(fromDate)=="" & trim(toDate) == "")){
			alert("Please enter From Action Date and To Action Date!");
			return false;
		}
    else{
		...
		{
			alert("Please enter From Action Date");
			return false;
		}
		else if((toDate == null || trim(toDate)== "" ) && (fromDate != null && trim(fromDate) != "" ))
		{
			alert("Please enter To Action Date");
			return false;
		}
		if(dateCompare(fromDate,toDate)==1)
		{			
				alert("From Action Date cannot be greater than To Action Date");
				return false;
		}
	}	
...
<div id="shadow" class="opaqueLayer"><font color="yellow" size="6"> Please wait..</font></div>
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"><table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>Copy and Cancel Report</span> 
			</td>
		...
		<fieldset width="100%" border="1" align="center" class="border3">
			<legend><b>Search</b></legend>
				<table border="0"  align="center" style="margin-top:7px">
					<tr>
						<td align="right" style="font-size:9px;"> From Action Date:</td>
						...
						<td align="right" style="font-size:9px;"> To Action Date:</td>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<table border="0" cellpadding="0" cellspacing="0" class='main'>       
				...
				<tr>
					<td align="center" class='inner col2 head1'><b>Old Order No</b></td>
					<td align="center" class='inner col2 head1'><b>New Order No</b></td>
					<td align="center" class='inner col2 head1'><b>Root Order No</b></td>		
					<td align="center" class='inner col2 head1'><b>Old Service No</b></td>	
					<td align="center" class='inner col2 head1'><b>New Service No</b></td>
					<td align="center" class='inner col3 head1'><b>Action Taken By</b></td>
					<td align="center" class='inner col2 head1'><b>Action Date</b></td>
				</tr>
				</table>
					 </div> 	
				...
				<logic:present name="copyCancelReportList" scope="request">
					<logic:notEmpty  name="copyCancelReportList" scope="request"> 					
						<logic:iterate id="row" name="copyCancelReportList" indexId="recordId">
							<%
							...
							<tr class="<%=classType%>">
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="newOrderNo"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="rootOrderNo"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="oldServiceNo"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="newServiceNo"/>&nbsp;</td>
								<td align="left" class='inner col3'><bean:write  name="row" property="createdBy"/>&nbsp;</td>
			   	 ...
			   	 <tr>
		          	<td colspan="3">
		              	<div class='horizontal-scrollcancelcopyreport' onscroll='reposHorizontal(this);'>
		                  	<div>
		                  	</div>
		              	</div>
		          	</td>
		     	 ...
		     	 <!-- End Scrolling and Freezing of Copy and Cancel Report   -->
					...
					<logic:empty  name="copyCancelReportList">
