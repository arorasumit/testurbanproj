...
<html>
<head>
<title>BCP Address - Report</title>
...
function exportToExcel()
{
	...
	myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewBCPList&inExcel=true";
...
<div id="shadow" class="opaqueLayer"><font color="yellow" size="6"> Please wait..</font></div>
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> <span>BCP ADDRESS REPORT</span> </div>
		...
		<fieldset width="100%" border="1" align="center" class="border3">
			<legend><b>Search</b></legend>
				<table border="0" cellspacing="0"  align="center" cellpadding="0" style="margin-top:7px">
					<tr>
						<td width="150px"/>
						<td align="right" style="font-size:9px" nowrap> A/C No:</td>
						<td align="left">
					...
					<tr>
						<td width="150px"/>
						<td align="right" style="font-size:9px">BCP Code:</td>
						<td align="left">
							<html:text  property="bcpIdStr" styleClass="inputBorder1" style="width:50px;float:left;" maxlength="18" onblur="if( trim(this.value).length>0){ return checkdigits(this)};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text>
						</td>
						<td width="10px"/>
						<td align="right" style="font-size:9px;" nowrap>BCP Name:</td>
						<td align="left"><html:text  property="bcpNameStr" styleClass="inputBorder1" style="width:160px;" maxlength="200" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'BCP Name')};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text></td>
						<td align="left">
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<table class="tab2" style="overflow:auto;" width="99%" border="1" align="center" id='tblBCPReport'>
				<tr>
					...
					<td align="center" style="font-size:9px"><b>
						<logic:present name="customerList" scope="request">
							<logic:notEmpty  name="customerList" scope="request"> 
								<a href="#" onclick="sortSubmit('bcpId')">BCP Code</a>
							</logic:notEmpty>
							<logic:empty  name="customerList" scope="request">
								BCP Code
							</logic:empty>
