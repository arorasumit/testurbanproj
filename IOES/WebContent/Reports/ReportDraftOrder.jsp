...
<html>
<head>
<title>Archival Draft Report</title>
...
function pagingSubmit(val)
{
	...
	myform.method.value='reportDraftOrder';
	showLayer();
	myform.submit();
}
...
function searchClick()
{
	...
	myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=reportDraftOrder";
		showLayerExcel();
		myForm.submit();
	}
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=reportDraftOrder&inExcel=true";
		showLayerExcel();
		myForm.submit();
	}
}
	...
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head">
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td align="left"> <span>Archival Draft Report</span>
					</td>
				<!-- Start [002] -->
			...
			<table border="0"  align="center" style="margin-top:7px" width="100%">
				<tr>
				 ...
				 <td nowrap><html:text  property="FROMDATE" styleId="dateFrom" styleClass="inputBorder1" style="width:75px;" readonly="true"></html:text>
					...
					<td align="left" nowrap width="139">
						<html:text  property="ckt_id" maxlength="25" onblur="if( trim(this.value).length>0){ return};" onchange="if( trim(this.value).length>0){return ValidateTextField(this,path,'ckt_id')};"></html:text>
					</td>
				...
				<tr>
					...
					<td align="right" style="font-size:9px" width="122">Order Line No</td>
					...
					<td align="left" nowrap width="106">
						<html:text  property="ACCOUNT_NUMBER" maxlength="25" onblur="if( trim(this.value).length>0){ return checkdigits(this)};" onchange="if( trim(this.value).length>0){return ValidateTextField(this,path,'ACCOUNT_ID')};"></html:text>
					</td>
		...
		<fieldset border="1" align="center" class="border2" >
			<legend> <b>Archival Draft Report</b></legend>
			<br/>
			<table width="100%">
				<tr>
					<td>
...
<td align="center" class='inner col3 head1' ><b>Billuom</b></td>
...
<td align="center" class='inner col3 head1' ><b>Charge Remarks </b></td>
...
<td align="center" class='inner col3 head1' ><b>CKT ID</b></td>
						...
						<div id='contentscroll' class='content1' onscroll='reposHead(this);'>
							<table border="0" cellpadding="0" cellspacing="0" class='content1' id='tableAdvancePaymentReport'>
								<logic:present name="reportDraftOrder" scope="request">
									<logic:notEmpty  name="reportDraftOrder" scope="request">
										<logic:iterate id="row" name="reportDraftOrder" indexId="recordId">
											<%
											...
											<tr class="<%=classType%>">
												...
												<td align="center" class='inner col3'>
												<a href="#" onclick="getAttachmentList(<bean:write  name="row" property="account_id"/>,<bean:write  name="row" property="order_no"/>,<bean:write name="row" property="account_number"/>);">
									...
									<logic:empty  name="reportDraftOrder">
