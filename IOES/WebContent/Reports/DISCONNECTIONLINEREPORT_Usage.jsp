...
function pagingSubmit(val)
{
	...
	//myform.method.value='viewDisconnectionLineReport&usage='+isUsage;
	myform.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewDisconnectionLineReport&usage="+isUsage;	
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewDisconnectionLineReport&inExcel=true&usage="+isUsage;
		showLayerExcel();
		myForm.submit();
	}
}
...
function isBlankForm()
{
	...
	var toDate=myForm.toDate.value;
		...
		if((fromDate == null & toDate == null) || ( trim(fromDate)=="" & trim(toDate) == "")){
			alert("Please From Date and To Date!");
		return false;
...
<html:hidden property="interfaceId"/>
		...
		<logic:equal name="isUsage" value="0">	
			<div border="1" class="head"> <span>DISCONNECTION LINE REPORT</span> </div>
		</logic:equal>
		<logic:equal name="isUsage" value="1">
			...
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>DISCONNECTION LINE REPORT(USAGE)</span> 
			</td>
			...
			<legend><b>Search</b></legend>
				<table border="0"  align="center" style="margin-top:7px">
					<tr>
						...
						<td align="left">
							<html:text  property="ordersubtype" 
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<table border="0" cellpadding="0" cellspacing="0" class='main'>       
				...
				<logic:equal name="isUsage" value="0">
					...
					<td align="center" style="font-size:9px"><b>Customer Name </b></td>
					...
					<td align="center" style="font-size:9px"  ><b>Billing Trigger Create Date </b></td>
					<td align="center" style="font-size:9px"  ><b>PM Provisioning Date </b></td>
					...
					<td align="center" style="font-size:9px"  ><b>Service Numher </b></td>
					...
					<td align="center" style="font-size:9px"  ><b>New Order Remarks </b></td>
					<td align="center" style="font-size:9px"  ><b>Copc Approval Date </b></td>
					<td align="center" style="font-size:9px"  ><b>Request Received Date </b></td>
				...
				<logic:equal name="isUsage" value="1">
					...
					<td align="center" class='inner col3 head1' ><b>Customer Name </b></td>
					...
					<td align="center" class='inner col2 head1' ><b>PM Provisioning Date </b></td>
					...
					<td align="center" class='inner col2 head1' ><b>Service Numher </b></td>
					<td align="center" class='inner col2 head1' ><b>Pre Crm Order Id </b></td>
					<td align="center" class='inner col2 head1' ><b>Disconnection Remarks </b></td>
					<td align="center" class='inner col2 head1' ><b>Order Stage </b></td>
					<td align="center" class='inner col2 head1' ><b>Service Stage </b></td>
					<td align="center" class='inner col2 head1' ><b>New Order Remarks </b></td>
					<td align="center" class='inner col2 head1' ><b>Copc Approved Date </b></td>
					<td align="center" class='inner col2 head1' ><b>Request Received Date </b></td>
					<td align="center" class='inner col2 head1' ><b>Standard Remarks </b></td>
					...
					<td align="center" class='inner col2 head1' ><b>Component End Status</b></td>
				 </logic:equal>
				<!-- Meenakshi : End -->	
					</tr>
					</table>
				...
				<logic:present name="DisconnectionLineReport" scope="request">
					<logic:notEmpty  name="DisconnectionLineReport" scope="request"> 					
						...
						<logic:equal name="isUsage" value="1">
							...
							<td align="left" class='inner col3'><bean:write  name="row" property="cust_name"/>&nbsp;</td>
							...
							<td align="left" class='inner col2'><bean:write  name="row" property="pre_crmorderid"/>&nbsp;</td>
							<td align="left" class='inner col2'><bean:write  name="row" property="disconnection_remarks"/>&nbsp;</td>
							...
							<td align="left" class='inner col2'><bean:write  name="row" property="neworder_remarks"/>&nbsp;</td>
							<td align="left" class='inner col2'><bean:write  name="row" property="copcapprovaldate"/>&nbsp;</td>
							<td align="left" class='inner col2'><bean:write  name="row" property="request_rec_date"/>&nbsp;</td>
			   	 ...
			   	 <tr>
		          	<td colspan="3">
		              	<div class='horizontal-scrolldisconnectlinereportusage' onscroll='reposHorizontal(this);'>
		                  	<div>
		                  	</div>
		              	</div>	
		          	</td>
