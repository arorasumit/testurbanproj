<!--[HYPR22032013001]    Vijay     30-March-2013    for Billing workqueue report  -->
...
function getInfoAndUpdate(partyNo,partyName) 
{
	...
	callerWindowObj.document.searchForm.partyNo.value = partyNo;
...
function DrawPartyTable()
{
		...
		//{
		 selectedSourcePartyNo=callerWindowObj.document.getElementById('partyNo').value;
		 if(selectedSourcePartyNo == null || trim(selectedSourcePartyNo)=="" ){
		 	selectedSourcePartyNo = 0;
		 }
		//}
...
<body>
<html:form action="/reportsAction" styleId="parties" method="post">
<bean:define id="formBean" name="reportsBean"></bean:define>
<bean:define id="pagingSorting" name="reportsBean" property="pagingSorting"/>
<!-- start [003] -->
