...
function pagingSubmit(val)
{
	...
	myform.method.value='viewContactList';	
	showLayer();
	myform.submit();
}
...
function searchClick()
{
	...
	myForm.action="<%=request.getContextPath()%>/reportsAction.do?method=viewContactList";
	showLayer();
	myForm.submit(); 
...
{
	var path = "<%=request.getContextPath()%>/NewOrderAction.do?method=fetchContactType&counter="+count+"&hdnContactTypeScreen=REPORT";		
	window.showModalDialog(path,window,"status:false;dialogWidth:500px;dialogHeight:300px");
}
...
<div id="shadow" class="opaqueLayer"><font color="yellow" size="6"> Please wait..</font></div>
	<html:form action="/reportsAction" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> <span>CONTACT REPORT</span> </div>
			...
			<legend><b>Search</b></legend>
				<table border="0" cellspacing="0"  align="center" cellpadding="0" style="margin-top:7px">
					<tr>
						...
						<td align="left">
							<html:text  property="accountIdStr" styleClass="inputBorder1" style="width:90px;float:left;" readonly="true" ></html:text>
						...
						<td align="left"><html:text  property="orderNoStr" styleClass="inputBorder1" style="width:70px;" maxlength="200" onblur="if( trim(this.value).length>0){ return checkdigits(this)};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text></td>
						<td align="left">
					...
					<tr>
						<td width="60px"/>
						<td align="right" style="font-size:9px">Contact Type:</td>
						<td align="left">
							<html:text  property="contactTypeStr" styleClass="inputBorder1" style="width:90px;float:left;" maxlength="25" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'Contact Type')};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text>
							<div class="searchBg1" align="left"><a
								href="#" onclick="return popContactType(1)">...</a>
						</td>
						<td width="10px"/>
						<td align="right" style="font-size:9px;">Contact Name:</td>
						<td align="left"><html:text  property="contactNameStr" styleClass="inputBorder1" style="width:160px;" maxlength="200" onblur="if( trim(this.value).length>0){return ValidateTextField(this,path,'Contact Name')};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text></td>
						<td width="50px"/>
						<td width="50px" colspan="4"/>
					...
					<tr height="5px"/>
					<tr>
						<td colspan="10" style="color: red;font-size: xx-small;" align="left" valign="bottom">*To see ALL Accounts, click on Search without entering any search criteria</td>
					</tr>					
				</table>
		</fieldset>
			...
			<table style="display:block;overflow:auto;" class="tab2" width="99%" border="1" align="center">
				<tr>
					...
					<td align="center" style="font-size:9px"><b>
						<logic:present name="customerList" scope="request">
							<logic:notEmpty  name="customerList" scope="request"> 
								<a href="#" onclick="sortSubmit('contactId')">Contact Id</a>
							</logic:notEmpty>
							<logic:empty  name="customerList" scope="request">
								Contact Id
							</logic:empty>
					...
					<td align="center" style="font-size:9px"><b>Contact Type</b></td>							
					<td align="center" style="font-size:9px"><b>Salutation</b></td>
					<td align="center" style="font-size:9px"><b>Contact Name</b></td>
