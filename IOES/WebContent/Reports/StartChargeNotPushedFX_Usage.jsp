...
function pagingSubmit(val)
{
	...
	myform.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewStartChargeNotPushedInFx&usage="+isUsage;
...
function exportToExcel()
{
	...
	if(!isBlankForm()){
		...
		myForm.action="<%=request.getContextPath()%>/reportsAction_Usage.do?method=viewStartChargeNotPushedInFx&inExcel=true&usage="+isUsage;
		showLayerExcel();
		myForm.submit();
	}
}
...
function isBlankForm()
{
	...
	if((orderType==null && fromOrderNo==null && toOrderNo==null && fromAccountNo==null && toAccountNo==null 
		&& verticalDetails == null) 
		|| (trim(orderType)=="" && trim(fromOrderNo)=="" && trim(toOrderNo)=="" 
		&& trim(fromAccountNo)=="" && trim(toAccountNo)=="" && trim(verticalDetails)=="")
		|| (orderType==null && fromOrderNo==0 && toOrderNo==0 && fromAccountNo==0 && toAccountNo==0 
		&& verticalDetails == null) 
		|| (trim(orderType)=="" && fromOrderNo==0 && toOrderNo==0 
		&& fromAccountNo==0 && toAccountNo==0 && trim(verticalDetails)=="")){
...
<div id="shadow" class="opaqueLayer"><font color="yellow" size="6"> Please wait..</font></div>
	<html:form action="/reportsAction_Usage" styleId="searchForm" method="post">
		...
		<div border="1" class="head"> <span>START CHARGE NOT PUSHED IN FX</span> </div>
		</logic:equal>
		<logic:equal name="isUsage" value="1">			
			...
			<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
				<tr ><td align="left"><span>START CHARGE NOT PUSHED IN FX (USAGE)</span> 
			</td>
			...
			<legend><b>Search</b></legend>
				<table border="0"  align="center" style="margin-top:7px">
					...
					<td width="90px"/>
						...
						<td align="left"><html:text  property="fromOrderNo" onblur="if( trim(this.value).length>0){ return checkdigits(this)};" onkeydown="if (event.keyCode == 13) return searchClick();"></html:text></td>
						<td width="10px"/>
		...
		<fieldset border="1" align="center" class="border2" >
			...
			<logic:equal name="isUsage" value="1">
				<legend> <b>Start Component Not Pushed In FX</b></legend>
			</logic:equal>
			<br/>
			<table width="100%">
				<tr>
				...
				<!-- Start Scrolling and Freezing of START CHARGE NOT PUSHED IN FX (USAGE)    -->
			...
			<tr>	
				<logic:equal name="isUsage" value="0">
					...
					<logic:present name="startChargeNotPushedInFxList" scope="request">
							...
							<logic:empty  name="startChargeNotPushedInFxList" scope="request">
								Order No
							</logic:empty>
						</logic:present>
						</b>
				...
				<logic:equal name="isUsage" value="1">
					...
					<td align="center" class='inner col2 head1'><b>CRM Account Number</b></td>	
					...
					<td align="center" class='inner col1 head1'><b>Si Id</b></td>
					...
					<td align="center" class='inner col2 head1'><b>Coll Manager</b></td>
					<td align="center" class='inner col2 head1'><b>Coll Mgr Mail</b></td>
					...
					<logic:notEmpty  name="startChargeNotPushedInFxList" scope="request"> 					
						<logic:iterate id="row" name="startChargeNotPushedInFxList" indexId="recordId">
							...
							<logic:equal name="isUsage" value="1">
								...
								<!--<td align="left" class='inner col2'>&nbsp;</td>Fx Status Ed-->
								...
								<td align="left" class='inner col1'><bean:write  name="row" property="fxSiId"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="coll_Manager"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="coll_Manager_Mail"/>&nbsp;</td>
								...
								<td align="left" class='inner col2'><bean:write  name="row" property="orderNumber"/>&nbsp;</td>						
								<!--<td align="left" class='inner col2'>&nbsp;</td> Charge Hdr Id-->
								...
								<td align="left" class='inner col1'><bean:write  name="row" property="totalPoAmt"/>&nbsp;</td>
								<td align="left" class='inner col2'><bean:write  name="row" property="sourcePartyID"/>&nbsp;</td>
			    ...
			    <td class='tableverticalscroll' rowspan="2">
			   	 ...
			   	 <tr>
		          	<td colspan="3">
		              	<div class='horizontal-scrollstartchargenotpushedinfxreportusage' onscroll='reposHorizontal(this);'>
		                  	<div>
		                  	</div>
		              	</div>	
		          	</td>
		     	 ...
		     	 <!-- End Scrolling and Freezing of START CHARGE NOT PUSHED IN FX (USAGE)    -->
